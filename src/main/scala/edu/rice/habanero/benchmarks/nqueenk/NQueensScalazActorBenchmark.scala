 ...
 */
object NQueensScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new NQueensScalazActorBenchmark)
  }

  private final class NQueensScalazActorBenchmark extends Benchmark {
