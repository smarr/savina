 ...
 */
object BankingJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new BankingJetlangActorBenchmark)
  }

  private final class BankingJetlangActorBenchmark extends Benchmark {
  ...
  protected class Teller(completion: Promise[Double], numAccounts: Int, numBankings: Int) extends JetlangActor[AnyRef] {
  ...
  protected class Account(id: Int) extends JetlangActor[AnyRef] {
