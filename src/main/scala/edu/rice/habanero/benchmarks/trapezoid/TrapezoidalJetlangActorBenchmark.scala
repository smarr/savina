 ...
 */
object TrapezoidalJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new TrapezoidalJetlangActorBenchmark)
  }

  private final class TrapezoidalJetlangActorBenchmark extends Benchmark {
  ...
  private class Master(completion: Promise[Double], numWorkers: Int) extends JetlangActor[AnyRef] {
  ...
  private class Worker(master: Master, val id: Int) extends JetlangActor[AnyRef] {
