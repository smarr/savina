 ...
 */
object GuidedSearchScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new GuidedSearchScalazActorBenchmark)
  }

  private final class GuidedSearchScalazActorBenchmark extends Benchmark {
  ...
  private class Worker(master: Master, id: Int) extends ScalazActor[AnyRef] {
