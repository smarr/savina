 ...
 */
object UctScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new UctScalazActorBenchmark)
  }

  private final class UctScalazActorBenchmark extends Benchmark {
   ...
   * @author <a href="http://shams.web.rice.edu/">Shams Imam</a> (shams@rice.edu)
   */
  protected class RootActor(completion: Promise[Int]) extends ScalazActor[AnyRef] {

    private final val ran: Random = new Random()
    private var height: Int = 1
    private var size: Int = 1
    private final val children = new Array[ScalazActor[AnyRef]](UctConfig.BINOMIAL_PARAM)
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        ...
        case booleanMessage: UctConfig.ShouldGenerateChildrenMessage =>
          val sender: ScalazActor[AnyRef] = booleanMessage.sender.asInstanceOf[ScalazActor[AnyRef]]
     ...
     */
    def checkGenerateChildrenRequest(childName: ScalazActor[AnyRef], childHeight: Int) {
  ...
  protected object NodeActor {
    def createNodeActor(parent: ScalazActor[AnyRef], root: ScalazActor[AnyRef], height: Int, id: Int, comp: Int): NodeActor = {
  ...
  protected class NodeActor(myParent: ScalazActor[AnyRef], myRoot: ScalazActor[AnyRef], myHeight: Int, myId: Int, myCompSize: Int) extends ScalazActor[AnyRef] {
