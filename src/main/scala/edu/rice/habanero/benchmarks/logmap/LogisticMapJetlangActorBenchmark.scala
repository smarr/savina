 ...
 */
object LogisticMapJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapJetlangActorBenchmark)
  }

  private final class LogisticMapJetlangActorBenchmark extends Benchmark {
  ...
  private class Master(completion: Promise[Double]) extends JetlangActor[AnyRef] {
  ...
  private class SeriesWorker(id: Int, master: Master, computer: RateComputer, startTerm: Double) extends JetlangActor[AnyRef] {
    private final val self = this
  ...
  private class RateComputer(rate: Double) extends JetlangActor[AnyRef] {
