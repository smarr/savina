 ...
 */
object PhilosopherJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PhilosopherJetlangActorBenchmark)
  }

  private final class PhilosopherJetlangActorBenchmark extends Benchmark {
